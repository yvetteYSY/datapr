...
- Use `v0` for backwards-compatible v0 updates, `v0.4.0` after publication for an immutable release reference, or a full commit SHA for maximum supply-chain control.
