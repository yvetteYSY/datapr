...
5. Create an immutable semantic release tag such as `v0.4.0` at the merge commit.
...
- Semantic tags such as `v0.3.0` and `v0.4.0` identify exact releases and are never moved.
